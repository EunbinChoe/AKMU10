...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/page-changes.js":[function(require,module,exports) {
function gameStarted() {
  ...
  var bag_items = document.querySelectorAll(".bag__item");
...
function nextPage() {
  ...
  if (document.getElementById("pg1_img").style.display == "block") {
    ...
    var clicks = document.querySelectorAll(".clicked");
    clicks.forEach(function (item) {
      return item.classList.remove("clicked");
    });
    var select = document.querySelectorAll(".selected__clue");
    select.forEach(function (item) {
      return item.classList.remove("selected__clue");
    });
    pg = 2;
    document.body.style.backgroundColor = "#e2ede1";
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/page-changes.js"], null)
//# sourceMappingURL=/page-changes.ff560490.js.map