...
function conversations(j) {
  ...
  if (j == 1) {
    if (i == 0) {
      ...
      clickeds.forEach(function (item) {
...
function myFunction1() {
  var x1 = document.getElementById("numb").value;
  var text;
  if (x1 == 140407) {
...
function myFunction2() {
  var pre_x2 = document.getElementById("txt").value;
  var x2 = pre_x2.replace(/\s/g, "");
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/input.js"], null)
