...
document.getElementById("pg6_img_1").style.display = "none";
document.getElementById("pg6_img_1close").style.display = "none";
document.getElementById("pg7_img").style.display = "none";
document.getElementById("pg5_box").style.display = "flex";
